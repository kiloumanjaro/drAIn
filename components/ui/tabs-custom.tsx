...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'relative inline-flex flex-1 items-center justify-center gap-2 px-4 py-2.5 text-sm whitespace-nowrap outline-none disabled:pointer-events-none disabled:opacity-50',
